...
\begin{figure}[htbp]
    ...
    \apanote[+6.2pt]{La evaluación retroalimenta ajustes del artefacto, pero no cambia el alcance metodológico: se evalúa un \textit{visual product twin}, no un gemelo digital operacional. Elaboración propia.}
\end{figure}
...
\begin{table}[htbp]
    ...
    \end{tabular}
    \apanote[-18.8pt]{La tabla presenta datos agregados de caracterización y no permite asociar perfiles con respuestas individuales. Elaboración propia.}
\end{table}
