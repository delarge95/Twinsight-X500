...
\begin{table}[htbp]
    ...
    \end{tabular}
    \apanote[14.4pt]{La coexistencia de varias rutas refleja la necesidad de adaptar el pipeline a distintos tipos de geometría CAD. Elaboración propia.}
\end{table}
...
\begin{table}[htbp]
    ...
    \end{tabular}
    \apanote{La tabla resume casos representativos y no pretende listar cada subpieza del pipeline. Su función es hacer auditable la relación entre fuente geométrica, operación aplicada y destino runtime. Elaboración propia.}
\end{table}
...
\begin{figure}[htbp]
    ...
    \apanote[14.4pt]{La figura muestra herramientas de preparación de activos; no corresponde a funciones visibles de la app final para usuarios. Elaboración propia.}
\end{figure}
...
\begin{table}[htbp]
    ...
    \end{tabular}
    \apanote{La modularización de fasteners integra datos, escena y optimización. Elaboración propia a partir de la escena y del runtime de fasteners del proyecto.}
\end{table}
...
\begin{table}[htbp]
    ...
    \end{tabular}
    \apanote{``Rango'' clasifica el tipo de inversión requerida sin fijar precios exactos sujetos a cambios comerciales. Elaboración propia.}
\end{table}
...
\begin{figure}[htbp]
    ...
    \apanote[14.4pt]{La figura resume la ruta de normalización y consumo de \texttt{DronePartData} en runtime, desde los activos importados y el catálogo hasta los controladores visibles de interfaz y escena. Elaboración propia.}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \apanote[14.4pt]{De izquierda a derecha se presentan los menús principales \textit{Inspect}, \textit{Analyze} y \textit{Studio}. Elaboración propia.}
\end{figure}
...
\begin{table}[htbp]
    ...
    \end{tabular}
    \apanote[14.4pt]{La tabla distingue entre tarjetas visibles, presets publicados indirectamente y capacidades ocultas. Elaboración propia.}
\end{table}
...
\begin{table}[htbp]
    ...
    \end{tabular}
    \apanote{Esta tabla resume el criterio usado para separar funciones visibles, funciones ocultas y módulos no integrados. Elaboración propia.}
\end{table}
