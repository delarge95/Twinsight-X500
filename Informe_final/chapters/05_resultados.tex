...
\begin{table}[htbp]
    ...
    \begin{tabular}{p{2.8cm}p{2.8cm}p{4.8cm}p{2.4cm}}
        \hline
    ...
    \end{tabular}
    \apanote[14.4pt]{Esta tabla resume el cierre funcional y no reemplaza las tablas cuantitativas posteriores. Elaboración propia.}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{p{3.1cm}p{4.8cm}p{3.8cm}p{2.1cm}}
        \hline
...
\begin{table}[htbp]
    ...
    \begin{tabular}{p{2.4cm}p{2.6cm}p{2.8cm}p{1.7cm}p{3.3cm}}
        \hline
        \textbf{Factor de forma} & \textbf{Navegador} & \textbf{Compatibilidad} & \textbf{Validado} & \textbf{Observaciones} \\ \hline
    ...
    \end{tabular}
    \apanote[6.2pt]{La tabla resume compatibilidad observada por factor de forma y navegador a partir de las sesiones del profiler interno. Elaboración propia.}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{p{2.8cm}p{3.8cm}p{4.0cm}p{1.8cm}}
        \hline
...
\begin{figure}[htbp]
    ...
    \apanote[-18.3pt]{Mapeo visual que conecta las fricciones de interacción táctil identificadas en la prueba previa de Think-Aloud con sus correspondientes soluciones implementadas en la interfaz de la build. Elaboración propia.}
\end{figure}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{p{3.1cm}p{2.2cm}p{2.2cm}p{2.2cm}p{4.1cm}}
        \hline
    ...
    \end{tabular}
    \apanote[-18.4pt]{La tabla sintetiza los registros estructurados del moderador por tarea y condición. La lectura cualitativa complementaria se presenta en la sección de \textit{Think-Aloud}. Elaboración propia.}
\end{table}
...
\begin{table}[htbp]
    ...
    \end{tabular}
    \apanote[-18.4pt]{Los tiempos se presentan en segundos. Sec. = secuencia de exposición; AB = visor 3D primero y soporte 2D después; BA = soporte 2D primero y visor 3D después. Elaboración propia a partir de los registros del moderador.}
\end{table}
...
\begin{table}[htbp]
    ...
    \end{tabular}
    \apanote[-18.4pt]{La diferencia se calcula como media del soporte 2D menos media del visor 3D. Elaboración propia.}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{p{3.7cm}p{2.6cm}p{7.8cm}}
        \hline
    ...
    \end{tabular}
    \apanote[-18.4pt]{La cifra de 95\,617 triángulos corresponde al modelo base optimizado exportado para la build. No equivale al conteo de escena runtime reportado por el profiler. Elaboración propia.}
\end{table}
