...
\setlength{\LTpre}{-2.0pt}
\setlength{\LTpost}{0pt}

{
\renewcommand{\arraystretch}{1.08}
\setlength{\tabcolsep}{2pt}
\begin{longtable}{p{2.5cm}p{2.1cm}p{2.65cm}p{0.9cm}p{1.05cm}p{1.25cm}p{1.1cm}p{2.15cm}}
    ...
    \textbf{Dispositivo} & \textbf{SO / navegador} & \textbf{Escenarios válidos} & \textbf{Dur. (s)} & \textbf{FPS prom.} & \textbf{Frame prom.} & \textbf{Pico mem.} & \textbf{Lectura} \\ \hline
    \endhead
    PC escritorio (Intel Core i7-5820K, GTX 980 Ti, 48 GB RAM), 1910\(\times\)903 & Windows 11 / Chrome 141 & Base, aislamiento, explode, cut, thermal & 253.4 & 59.8 & 16.7 ms & 413 MB & Fluidez estable en todos los escenarios operativos. \\
...
\begin{longtable}{p{3.8cm}p{3.2cm}p{7.0cm}}
...
\begin{longtable}{p{3.0cm}p{2.75cm}p{1.1cm}p{1.05cm}p{1.25cm}p{1.25cm}p{1.35cm}p{1.55cm}}
