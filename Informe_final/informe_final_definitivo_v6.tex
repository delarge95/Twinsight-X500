...
\usepackage{float}
\usepackage{placeins}
\usepackage{flafter}                  % \FloatBarrier SOLO para casos puntuales
\usepackage{caption}
\usepackage{amsmath}
\usepackage{amsfonts}
\usepackage{amssymb}
...
\setlength{\@fptop}{0pt}
\makeatother
% Control estructural del colocador de flotantes (v6):
% Pool ampliado para evitar saturacion de la cola interna de LaTeX.
\setcounter{topnumber}{4}
\setcounter{bottomnumber}{2}
\setcounter{totalnumber}{6}
% Parametros relajados para que una figura grande comparta pagina con
% texto (debajo del flotante) en vez de ser exiliada a pagina de flotantes.
\renewcommand{\topfraction}{0.9}
\renewcommand{\bottomfraction}{0.8}
\renewcommand{\textfraction}{0.07}
\renewcommand{\floatpagefraction}{0.75}
% Separadores flotante-texto en CERO. Con flotantes [tp], el unico
% contacto flotante-texto es "nota -> texto debajo de un flotante al
% tope": ese hueco queda en \textfloatsep(0) + el pegamento interlineal
% normal (18.5pt, el ritmo 2.0). Uniforme por construccion.
% TRAMPA A EVITAR: no usar multiplos de \baselineskip en el preambulo
% (ahi el registro vale 14.5pt, no 29pt).
...
% El \setstretch{2} explicito dentro del grupo la hace inmune a la
% herencia del hook 1.15 de las tablas.
% SIN \vspace inicial: la nota sigue a la figura/tabla con el pegamento
% interlineal puro. Cualquier \vspace aqui (positivo o NEGATIVO) rompe
% la geometria: el positivo crea el hueco "demasiado grande" entre
% imagen y nota; el negativo monta el texto sobre el ultimo renglon.
\newcommand{\apanote}[1]{%
    \par%
    \begingroup%
    \setstretch{2}%
